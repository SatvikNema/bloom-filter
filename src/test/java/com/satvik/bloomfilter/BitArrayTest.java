package com.satvik.bloomfilter;
...
class BitArrayTest {
  ...
  @Test
  @DisplayName(
      "works as expected there are negative values set in the bit array (for 63 or 127 or so on)")
  void testSetBit_8() {
    BitArray bitArray = new BitArray(200);
  ...
  void testSetBit_9() throws IOException {
    String filepath =
        "/Users/satvik.nema/Documents/learnings/worlds-simplest-db/lsm-db/bloom_filter_serialise.txt";
    int size = 200;
